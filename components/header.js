...
const Header = () => (
  <Navbar bg="primary" variant="dark" expand="sm" sticky="top" collapseOnSelect={true}>
    <Navbar.Brand className="navbar-brand" href="/" style={{ fontFamily: "HanleyPro-Script", fontSize: "3em", marginTop: "-0.3em", marginBottom: "-0.3em", paddingTop: "0", paddingBottom: "0" }}>
      Leon York
    </Navbar.Brand>
    <Navbar.Toggle aria-controls="basic-navbar-nav" style={{ marginBottom: "-0.3em", marginTop: "-0.3em" }}>
    ...
    <Navbar.Collapse id="basic-navbar-nav" style={{ paddingTop: "0", paddingBottom: "0", marginBottom: "-1em", marginTop: "-1em" }}>
      ...
      <Nav className="ml-auto" >
        <Nav.Link href="https://www.npmjs.com/~leonyork">
          <svg style={{ "display": "inline-block", "width": "2rem", "height": "2rem" }} version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 18 7">
            <title>npm</title>
        ...
        <Nav.Link href="https://hub.docker.com/u/leonyork">
          <svg style={{ "display": "inline-block", "width": "2rem", "height": "2rem" }} xmlns="http://www.w3.org/2000/svg" viewBox="64 64 400 400">
        ...
        <Nav.Link href="https://github.com/leonyork">
          <svg style={{ "display": "inline-block", "width": "2rem", "height": "2rem" }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 499.36">
            <title>GitHub</title>
